...
create table MOM(
	...
	M_NAME NVARCHAR2(7) NOT NULL,		--회원이름(NN)
...
create table DOGCARD(	
	...
	D_NAME NVARCHAR2(7) NOT NULL,		--강아지이름(NN)
...
create table HOSPITAL(
	...
	H_JOB NVARCHAR2(7) NOT NULL,		--업무내용(NN)
	H_MGR NVARCHAR2(7) default NULL,	--부서장
	constraint HOSPITAL_PK primary key(H_CODE)
);
create table EMP (
	E_NUMBER CHAR(5),			--직원사번(PK)
	E_NAME NVARCHAR2(7) NOT NULL,		--직원이름(NN)
