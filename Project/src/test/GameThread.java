...
public class GameThread extends Thread{
    ...
    public void countRound(){
        if(roundCount.size() == 0){
            ...
            System.out.println("//Round" + 2 +"//Slav "+client1);
            System.out.println("//Round" + 2 +"//Slav "+client2);
        }else {
            int nextRound = roundCount.get(0) + 1;
            if(nextRound == 4) {
                sendMessage("//Round4//Slav " + client1); //카드 교체 로직이므로 이 예약어가 들어오면 카드를 교체해서 셋팅해주세요
                sendMessage("//Round4//King " + client2);
                //roundCount.clear();
            }else if(nextRound == 5){
            	sendMessage("//Round5//Slav " + client1);
            	sendMessage("//Round5//King " + client2);
            }else if(nextRound == 6){
            	sendMessage("//Round6//Slav " + client1);
            	sendMessage("//Round6//King " + client2);
            }else  {
